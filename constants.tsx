...
import { City, UserRole, User } from './types';

// Sectors Data
export const SECTORS_SD = [
...
export const SECTORS_LC = [
  'La Concordia', 'Plan Piloto', 'Moterrey', 'Villegas'
];

// Logo Component
export const AppLogo = ({ className = "h-16 w-auto" }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 176 82.5">
    <defs>
      <style>{`
        .st0 { fill: #3cbdb2; }
        .st1 { fill: #f0e40b; }
...
export const INITIAL_USERS: User[] = [
  {
    ...
    password: 'RETO2026@', // In a real app, this should be hashed
    name: 'Admin',
    surname: 'Master',
    age: 30,
    phone: '0999999999',
    city: City.SANTO_DOMINGO,
    sector: 'Zaracay',
...
export const EMAILJS_CONFIG = {
  SERVICE_ID: 'service_pkc5h87',
  TEMPLATE_ID: 'template_rgm0xms',
  PUBLIC_KEY: 'owUYyPbGCKtFmhc8n'
};